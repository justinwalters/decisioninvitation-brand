...
**0.3.0 · Decision Instrument identity proposal, pending owner review.** These kits distribute exact, usable files; they do not establish owner approval, trademark clearance, print approval, deployment, or downstream adoption.

## Choose a kit

| Filename | Intended use |
| --- | --- |
| `decisioninvitation-brand-0.3.0.zip` | Complete public identity: standards, manual, fonts/notices, production assets, editable applications, source, tools, tests, and public page source |
| `decisioninvitation-logos-0.3.0.zip` | Five Commitment Gate forms in four modes: outlined SVG, transparent PNG, and vector PDF; logo/color standards and asset terms |
| `decisioninvitation-templates-0.3.0.zip` | Editable HTML/CSS applications and briefs with referenced logos, tokens, licensed fonts, and channel guidance |
| `decisioninvitation-webfonts-0.3.0.zip` | Supplied Sora Regular and SemiBold files, original OFL notice, typography guidance |
