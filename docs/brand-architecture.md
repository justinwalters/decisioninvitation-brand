...
DecisionInvitation is the visible product brand. It should be recognized without aSUKIra context.
...
Do not use aSUKIra’s primary palette, typography, editorial layout logic, signature wordmark behavior, or icon construction as a DecisionInvitation system. Provenance should reward close observation, not dominate first impression.
