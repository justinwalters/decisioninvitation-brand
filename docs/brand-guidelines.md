...
Start with the decision tension, clarify what contribution is useful, and name who owns the call. Invite without pressuring. The brand does not promise agreement, objectivity, speed, anonymity, encryption, compliance, or business outcomes. Privacy language must state who can see each contribution and reflect implemented access behavior.

The parent relationship belongs in a quiet footer or provenance note. Never turn it into a co-lockup, endorsement badge, or a claim about acquisition history without verified wording.

## Reference map

| Need | Source |
|---|---|
| Audience, differentiation, rationale | `brand-strategy.md` |
| Voice and product language | `messaging-and-voice.md` |
| Mark and lockups | `logo-standards.md` |
| Palette and contrast | `color-and-accessibility.md` |
| Type hierarchy | `typography.md` |
| Composition and imagery | `art-direction.md` |
| Motion | `motion-and-interaction.md` |
| Web implementation | `website-guidelines.md` |
| Governance and release | `governance-and-release.md` |
