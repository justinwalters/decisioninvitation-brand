...
| `email-and-documents.md` | operational communication standards |
| `social-media-guidelines.md` | channel-safe identity use |
| `motion-and-interaction.md` | convergence, timing, reduced motion |
